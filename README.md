...
本项目是一个基于NVIDIA BlueField DPU和深度学习技术的**智能网络安全防御系统**，专为第三届NVIDIA DPU中国黑客松竞赛设计。系统采用**混合检测架构**，结合传统规则检测与AI深度学习检测，实现了从被动防御到主动预防的范式转换。
...
| 开发者 | 主要贡献 | 技术专长 |
|--------|----------|----------|
| 崔湛林 | 系统架构、核心算法、项目管理 | Python、系统设计、DPU技术 |
| Zeke | AI模型、区块链集成、安全算法 | 机器学习、区块链、密码学 |
| 严阳 | 深度学习、特征工程、模型优化 | PyTorch、数据科学、算法优化 |
...
*本项目由新南威尔士大学本科生崔湛林领衔，新加坡区块链与AI专家Zeke和AI开发者严阳共同开发，专为第三届NVIDIA DPU中国黑客松竞赛设计。* 